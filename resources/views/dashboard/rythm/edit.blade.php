...
@section('document')
    ...
    <section class="p-5">
        ...
        <article class=" bg-white rounded mb-6 p-4 shadow-sm text-lg font-extrabold flex items-center">
            ...
            <div class="w-4/12">
                <i class="fas fa-water"></i> <span>Mettre à jour le rythme</span>
            </div>
        ...
        <article class="bg-white rounded shadow-sm mt-8 p-4">
            ...
            <form action="{{ route('rythm.update',['rythm' => $rythm->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="my-3">
                    ...
                    <input type="text" autocomplete="off" name="title" value="{{ $rythm->title }}" placeholder="Titre du rythme" class="w-8/12 p-2 border border-gray-400 rounded focus:outline-none">
                ...
                <div class="my-3">
                    ...
                    <textarea name="description" id="" placeholder="Description du rythme" class="w-8/12 p-2 border border-gray-400 rounded focus:outline-none">{{ $rythm->description }}</textarea>
